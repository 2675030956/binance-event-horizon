...
- 生成时间：2026-08-12T21:08:16.815015+00:00
- 市场相位：高热分歧
- 相位摘要：注意力先跑，资金确认跟得不够，容易出现热度先行的分歧行情。

## 信号星图
- 官方催化带 | 强度 45.9 | 资产：BTC、ETH、BNB、DOS
- 社媒引力场 | 强度 44.0 | 资产：BTC、ETH、BNB、PUMP
- Alpha 前沿层 | 强度 34.0 | 资产：DOS、PUMP、AEON、QUQ
- 聪明钱跃迁层 | 强度 29.9 | 资产：EGO、SPERP、SE、APP
- Launchpad 迷因团 | 强度 29.9 | 资产：EGO、SPERP、SE、APP

## 场景引擎
- BTC 点火突破窗 | Official Ignition | 窗口 6h-24h | 触发：新增配套产品、现货承接或公告后二次流动性扩散出现。
- EGO 聪明钱跟随窗 | Smart Money Follow-Through | 窗口 6h-24h | 触发：信号数量增加或流入重新放大，价格不跌回触发前区间。
...
- EGO | Core Orbit | 聪明钱或信号确认偏强
- SPERP | Core Orbit | 聪明钱或信号确认偏强
