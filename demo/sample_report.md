...
- 生成时间：2026-05-17T10:55:42.416179+00:00
- 市场相位：高热分歧
- 相位摘要：注意力先跑，资金确认跟得不够，容易出现热度先行的分歧行情。

## 信号星图
- 官方催化带 | 强度 39.8 | 资产：BTC、AIGENSYN
- 社媒引力场 | 强度 37.5 | 资产：BTC、BNB、ETH、ZEC
- Alpha 前沿层 | 强度 35.0 | 资产：IRYS、QUQ、UB、OPG
- 聪明钱跃迁层 | 强度 33.0 | 资产：IRYS、HAUSDORFF、雪、HANTA
- Launchpad 迷因团 | 强度 27.6 | 资产：HAUSDORFF、雪、GAPLA、SLND

## 场景引擎
- BTC 点火突破窗 | Official Ignition | 窗口 6h-24h | 触发：新增配套产品、现货承接或公告后二次流动性扩散出现。
- IRYS 聪明钱跟随窗 | Smart Money Follow-Through | 窗口 6h-24h | 触发：信号数量增加或流入重新放大，价格不跌回触发前区间。
- QUQ Alpha 先行扩散 | Alpha Frontier Expansion | 窗口 12h-24h | 触发：Alpha 交易强度延续，并向更主流交易层扩散。

## 引力预警
- 雷霆 | Medium | 链上风险或标签风险偏高；流动性偏薄

## 优先观察轨道
- BTC | Catalyst Orbit | 官方催化已入场；社媒热度已形成外部引力
- IRYS | Frontier Orbit | 聪明钱或信号确认偏强；Alpha 前沿强度高
...
## 广播封包
- 标题：高热分歧 | 官方催化带 监测摘要
- X：币安事件地平线最新监测：当前市场处于 高热分歧 阶段，主导驱动为 官方催化带，优先跟踪资产为 BTC，首要风险关注 雷霆。
